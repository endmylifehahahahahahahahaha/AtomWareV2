...
AtomWareFunctions.GlobaliseObject("BedwarsInfoNotification", BedwarsInfoNotification)
...
AtomWareFunctions.GlobaliseObject("BedwarsErrorNotification", BedwarsErrorNotification)
...
--[[run(function()
    ...
    local RankIconTable = {["Emerald"] = "rbxassetid://12599231807",["Nightmare"] = "rbxassetid://7904292926",["AtomWare"] = "rbxassetid://18518244636"}
    ...
    local function registerType(typeName)
        ...
        elseif typeName == "RankIcon" then LeaderboardEditor_Editors["RankIcon"] = {Value = "AtomWare"}; Leaderboard_AddOnCreator_Helper["RankIcon"] = {Type = "CreateDropdown", Args = {Name = "RankIcon", List = fetchRankIconNames(), Function = fetchDefaultFunction}, ResType = "Value"};
