...
run(function()
    ...
    local function makeDraggable(gui, window)
        ...
        scale = scale or GuiLibrary.MainGui.ScaledGui:FindFirstChildOfClass("UIScale")
    ...
    CustomChat = GuiLibrary.ObjectsThatCanBeSaved.WorldWindow.Api.CreateOptionsButton({
        Name = "CustomChat",
        Function = function(call)
			Config.Enabled = call
            if call then
...
run(function()
	...
	local Players
	local RunService
	StreamerMode = GuiLibrary.ObjectsThatCanBeSaved.WorldWindow.Api.CreateOptionsButton({
		Name = "StreamerMode",
		Function = function(call)
			if call then
				Players = Players or Services.Players
...
run(function()
    ...
    NeonCircles = GuiLibrary.ObjectsThatCanBeSaved.WorldWindow.Api.CreateOptionsButton({
        Name = "Neon Traces",
...
run(function()
	...
	trails = GuiLibrary.ObjectsThatCanBeSaved.WorldWindow.Api.CreateOptionsButton({
		Name = 'Wave Trails',
